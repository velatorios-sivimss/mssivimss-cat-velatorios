...
public class RestTemplateUtil {
    ...
    /**
     * Env&iacute;a una peticion con Body.
     *
     * @param url
     * @param clazz
     * @return
    ...
    /**
     * Env&iacute;a una peticion con Body y token.
     *
     * @param url
     * @param clazz
     * @return
    ...
    /**
     * Crea los headers para la peticion falta agregar el tema de seguridad
     * para las peticiones
     *
     * @return
     */
    ...
    /**
     * Crea los headers para la peticion con token
    ...
    /**
     * Crea los headers para la peticion con token, falta agregar el
     * tema de seguridad para las peticiones
     *
     * @return
     */
    /**
     * Env&iacute;a una peticion con Body, archivos y token.
     *
     * @param url
     * @param clazz
     * @return
