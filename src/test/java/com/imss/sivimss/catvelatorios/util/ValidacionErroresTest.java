...
public final class ValidacionErroresTest {
    ...
    public void testIsError_ReturnError() throws Exception {
        ValidacionErrores validacionErrores = ((ValidacionErrores) createInstance("com.imss.sivimss.catvelatorios.util.ValidacionErrores"));
        setField(validacionErrores, "com.imss.sivimss.catvelatorios.util.ValidacionErrores", "error", false);
